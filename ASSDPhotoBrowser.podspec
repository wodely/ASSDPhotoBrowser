...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ASSDPhotoBrowser.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/liukecyl@163.com/ASSDPhotoBrowser'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'liukecyl@163.com' => '540548997@qq.com' }
  s.source           = { :git => 'https://github.com/liukecyl@163.com/ASSDPhotoBrowser.git', :tag => s.version.to_s }
